...
Main.o: ./src/Main.c ./header/*.h
	gcc -Wall -Werror -Wextra -c ./src/Main.c -o ./bin/Main.o -lSDL2-2.0 -lSDL2_image -lSDL2_ttf -lSDL2_mixer
 
Map.o: ./src/Map.c ./header/*.h
	gcc -Wall -Werror -Wextra -c ./src/Map.c -o ./bin/Map.o -lSDL2-2.0 -lSDL2_image -lSDL2_ttf -lSDL2_mixer
...
Building.o: ./src/Building.c ./header/*.h
	gcc -Wall -Werror -Wextra -c ./src/Building.c -o ./bin/Building.o -lSDL2-2.0 -lSDL2_image -lSDL2_ttf -lSDL2_mixer

Spell.o: ./src/Spell.c ./header/*.h
	gcc -Wall -Werror -Wextra -c ./src/Spell.c -o ./bin/Spell.o -lSDL2-2.0 -lSDL2_image -lSDL2_ttf -lSDL2_mixer
...
Keybinds.o: ./src/Keybinds.c ./header/*.h
	gcc -Wall -Werror -Wextra -c ./src/Keybinds.c -o ./bin/Keybinds.o -lSDL2-2.0 -lSDL2_image -lSDL2_ttf -lSDL2_mixer
